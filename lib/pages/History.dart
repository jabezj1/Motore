			...
			body: SingleChildScrollView(
				child: Column(
					children: [
						...
						const HistoryWidget(imageLink: "lib/icons/expense.png", contTitle: "Monthly Expenses", descText: "This month's expenses: \n", value: "5000"),
						const HistoryWidget(imageLink: "lib/icons/oil_two.png", contTitle: "Gas Expenses", descText: "Last fuelup cost: \n", value: "50"),
						const HistoryWidget(imageLink: "lib/icons/past.png", contTitle: "Maintenance History", descText: "Date of last maintenance: \n", value: "01/01/01")
					],
				),
			),
		);
